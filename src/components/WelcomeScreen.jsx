            ...
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  <div className="mb-2 sm:mb-4">
                    <span
                      data-aos="fade-right"
                      data-aos-delay="200"
                      className="inline-block px-2 bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-white"
                    >
                      Welcome
                    </span>{" "}
                    <span
                    ...
                    <span
                      data-aos="fade-right"
                      data-aos-delay="600"
                      className="inline-block px-2 bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-[#6366f1]"
                    >
                      BARTR
                    </span>
                  </div>
                  <div>
                    ...
                    >
                      Skill-Based Trading Revolution
                    </span>
                  </div>
                </h1>
                ...
                <p
                  ...
                  data-aos-delay="1500"
                >
                  Trade your skills. Earn trust. Build reputation.
                </p>
              </motion.div>
                ...
                <a className="inline-flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-full relative group hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent ">
                      <TypewriterEffect text="Launching your trading dashboard..." />
                    </span>
                  </div>
                </a>
              </motion.div>
