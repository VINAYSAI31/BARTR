  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-gold text-primary-foreground hover:shadow-premium transform hover:scale-105 font-semibold",
        hero: "bg-gradient-primary text-primary-foreground hover:bg-gradient-hero shadow-elegant hover:shadow-premium transform hover:scale-105 font-semibold relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/10 before:to-transparent before:translate-x-[-100%] hover:before:translate-x-[100%] before:transition-transform before:duration-700",
        coral: "bg-gradient-coral text-accent-foreground hover:shadow-premium transform hover:scale-105 font-medium",
      },
      size: {
